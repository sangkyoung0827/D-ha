...
React는 온보딩, 최소 HUD, 공통 `GameRoom`, 방별 `ContextTray`, 통합 아이콘 내비게이션, 오버레이, 접근성 컨트롤과 PWA 업데이트 UI를 담당합니다. Phaser는 전신 Keeper, 7개 공간 배경, 터치·드래그 반응, 파티클과 세 미니게임의 프레임 루프만 담당합니다. Phaser Scene이 경제나 저장소를 직접 수정하지 않습니다.
